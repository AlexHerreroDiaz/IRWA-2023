...
from myapp.search.load_corpus import load_corpus, load_tweets_as_documents
...
corpus, index_d, tf, df, idf, title_index, data_ids = load_tweets_as_documents(path)
...
def search_form_post():
    ...
    results = search_engine.search(search_query, search_id, corpus, index_d, tf, df, idf, title_index, data_ids)
